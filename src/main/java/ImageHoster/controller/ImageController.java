...
public class ImageController {
    ...
    //Method recieves id and title of the image as pathVariable and comment as requestParam
    //Saves the comment on the database by creating a comment object with required params
    @RequestMapping(value = "/image/{id}/{title}/comments",  method = RequestMethod.POST)
    private String createComment(@RequestParam(name = "comment") String comment, @PathVariable("id") Integer imageId, @PathVariable("title") String imageTitle, HttpSession session, Model model){
        ...
        commentsService.createComment(commentObj);
