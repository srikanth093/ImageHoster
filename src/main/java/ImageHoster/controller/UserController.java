...
public class UserController {
    ...
    public String registerUser(User user, Model model) {
        ...
        //checks if the password is alphanumeric and special characters
        ...
        //If the password is valid store it in database else redirect back to registration page with the error msg
        if(numberPresent && charPresent && specialCharacterPresent){
